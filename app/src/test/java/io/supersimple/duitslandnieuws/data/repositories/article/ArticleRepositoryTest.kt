...
class ArticleRepositoryTest {
    ...
    fun testGet() {
        ...
        verify(mockCache).save(eq(testArticle))
    ...
    fun testFetch() {
        ...
        verify(mockDisk).save(eq(testArticle))
    }
    ...
    fun testList() {
        ...
        verify(mockCache).list(anyInt(), anyInt())
        verify(mockCache).save(any<List<Article>>())
        verify(mockDisk).list(anyInt(), anyInt())
    }
    ...
    fun testListNextPage() {
        ...
        verify(mockCache).save(any<List<Article>>())
        verify(mockDisk).list(anyInt(), anyInt())
        verify(mockDisk).save(any<List<Article>>())
    }
    ...
    fun testDelete() {
        ...
        verify(mockCache).delete(eq(testArticle))
        verify(mockDisk).delete(eq(testArticle))
    }
